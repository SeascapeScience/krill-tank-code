...
```{r}
rm(list=ls(all=TRUE))
load("~/Post-doc/Data/Total Merged Data File (July 12 2022).RData")
```
...
kd8 <- density(CC.TotalData$heading.pi[CC.TotalData$Chlorophyll=="5.5"])
lines(kd8, col='orange', lwd=2)
...
## should be
ChlA0$heading <- atan2(ChlA0$dx, ChlA0$dy)
ChlA0$heading.pi <- ChlA0$heading/(2*pi)*360

ChlA4.3$heading <- atan2(ChlA4.3$dx, ChlA4.3$dy)
ChlA4.3$heading.pi <- ChlA4.3$heading/(2*pi)*360

ChlA4.6$heading <- atan2(ChlA4.6$dx, ChlA4.6$dy)
ChlA4.6$heading.pi <- ChlA4.6$heading/(2*pi)*360

ChlA5.5$heading <- atan2(ChlA5.5$dx, ChlA5.5$dy)
ChlA5.5$heading.pi <- ChlA5.5$heading/(2*pi)*360

ChlA6$heading <- atan2(ChlA6$dx, ChlA6$dy)
ChlA6$heading.pi <- ChlA6$heading/(2*pi)*360

ChlA7$heading <- atan2(ChlA7$dx, ChlA7$dy)
ChlA7$heading.pi <- ChlA7$heading/(2*pi)*360

ChlA13$heading <- atan2(ChlA13$dx, ChlA13$dy)
ChlA13$heading.pi <- ChlA13$heading/(2*pi)*360

ChlA19$heading <- atan2(ChlA19$dx, ChlA19$dy)
ChlA19$heading.pi <- ChlA19$heading/(2*pi)*360
