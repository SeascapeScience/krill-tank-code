...
## copied from notebook00-merginf files and adding columns
##TotalData$heading <- atan(TotalData$dx/TotalData$dy), ## this is how it was calculated
...
plot(kd1, xlim = c(-85,85), ylim = c(0, 0.035), col='blue', lwd=2, main = "Heading Vs Flow Rate")
