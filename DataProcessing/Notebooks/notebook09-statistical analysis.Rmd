...
```{r}
rm(list=ls(all=TRUE))
load("~/Post-doc/Data/Total Merged Data File (Sep 20 2023).RData")
###str(CC.TotalData)
```
...
mod1=aov(v~Flow.rate*Chem*Light, data=AGG_Feed)
...
posth=glht(mod1, linfct=mcp(Chem*Light*Flow.rate="Tukey"))
