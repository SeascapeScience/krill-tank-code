...
```{r}
rm(list=ls(all=TRUE))
load("C:\\Users\\Nicole Hellessey\\Documents\\Post-doc\\Data\\Total Merged Data File (May 27 2022).Rdata")
```
...
xyplot(CC.TotalData$turn.angle~CC.TotalData$Flow.rate|CC.TotalData$Light*CC.TotalData$Guano,  main="Scatterplots by Light and Guano", 
...
plot(kd1, col='blue', lwd=2, main = "Turn Angles Vs Flow Rate")
...
kd1 <- density(CC.TotalData$turn.angle[CC.TotalData$Chlorophyll=="0"])
plot(kd1, col='blue', lwd=2, main = "Turn Angles Vs Chlorophyll")

kd2 <- density(CC.TotalData$turn.angle[CC.TotalData$Chlorophyll=="4.3"])
lines(kd2, col='light blue', lwd=2)

kd3 <- density(CC.TotalData$turn.angle[CC.TotalData$Chlorophyll=="4.6"])
lines(kd3, col='yellow', lwd=2)

kd4 <- density(CC.TotalData$turn.angle[CC.TotalData$Chlorophyll=="6.1"])
lines(kd4, col='orange', lwd=2)

kd5 <- density(CC.TotalData$turn.angle[CC.TotalData$Chlorophyll=="7.6"])
lines(kd5, col='red', lwd=2)

kd6 <- density(CC.TotalData$turn.angle[CC.TotalData$Chlorophyll=="13.5"])
lines(kd6, col='purple', lwd=2)

kd7 <- density(CC.TotalData$turn.angle[CC.TotalData$Chlorophyll=="19"])
...
kd1 <- density(CC.TotalData$turn.angle[CC.TotalData$Guano=="Present"])
plot(kd1, col='blue', lwd=2, main = "Turn Angles Vs Guano")

kd2 <- density(CC.TotalData$turn.angle[CC.TotalData$Guano=="Absent"])
...
plot(kd1, col='blue', lwd=2, main = "Turn Angles Vs Light")
...
kd1 <- density(CC.TotalData$log.vel.flow[CC.TotalData$Flow.rate=="0"])
plot(kd1, col='blue', lwd=2, main = "Velocity (in relation to flow) Vs Flow Rate")

kd2 <- density(CC.TotalData$log.vel.flow[CC.TotalData$Flow.rate=="0.6"])
lines(kd2, col='light blue', lwd=2)

kd3 <- density(CC.TotalData$log.vel.flow[CC.TotalData$Flow.rate=="3"])
lines(kd3, col='yellow', lwd=2)

kd4 <- density(CC.TotalData$log.vel.flow[CC.TotalData$Flow.rate=="5.9"])
lines(kd4, col='orange', lwd=2)

kd5 <- density(CC.TotalData$log.vel.flow[CC.TotalData$Flow.rate=="8.9"])
lines(kd5, col='red', lwd=2)
...
kd1 <- density(CC.TotalData$log.vel.flow[CC.TotalData$Chlorophyll=="0"])
plot(kd1, col='blue', lwd=2, main = "Velocity (in relation to flow) Vs Chlorophyll")

kd2 <- density(CC.TotalData$log.vel.flow[CC.TotalData$Chlorophyll=="4.3"])
lines(kd2, col='light blue', lwd=2)

kd3 <- density(CC.TotalData$log.vel.flow[CC.TotalData$Chlorophyll=="4.6"])
lines(kd3, col='yellow', lwd=2)

kd4 <- density(CC.TotalData$log.vel.flow[CC.TotalData$Chlorophyll=="6.1"])
lines(kd4, col='orange', lwd=2)

kd5 <- density(CC.TotalData$log.vel.flow[CC.TotalData$Chlorophyll=="7.6"])
lines(kd5, col='red', lwd=2)

kd6 <- density(CC.TotalData$log.vel.flow[CC.TotalData$Chlorophyll=="13.5"])
lines(kd6, col='purple', lwd=2)

kd7 <- density(CC.TotalData$log.vel.flow[CC.TotalData$Chlorophyll=="19"])
lines(kd7, col='black', lwd=2)
...
kd1 <- density(CC.TotalData$log.vel.flow[CC.TotalData$Guano=="Present"])
plot(kd1, col='blue', lwd=2, main = "Velocity (in relation to flow) Vs Guano")

kd2 <- density(CC.TotalData$log.vel.flow[CC.TotalData$Guano=="Absent"])
lines(kd2, col='red', lwd=2)
...
plot(kd1, col='blue', lwd=2, main = "Velocity (in relation to flow) Vs Light")
...
plot(kd1, col='blue', lwd=2, main = "Heading Vs Flow Rate")
...
plot(kd1, col='blue', lwd=2, main = "Heading Vs Chlorophyll")
...
plot(kd1, col='blue', lwd=2, main = "Heading Vs Guano")
...
plot(kd1, col='blue', lwd=2, main = "Heading Vs Light")
