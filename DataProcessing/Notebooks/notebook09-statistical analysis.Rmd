...
kd1 <- density(l1$vel.flow[l1$Guano=="Present"])
plot(kd1, xlim = c(-12,12), ylim = c(0, 6), col='blue', lwd=2, main = "Velocity (in relation to flow, not logged) Vs Guano, Lights On")

kd2 <- density(l1$vel.flow[l1$Guano=="Absent"])
lines(kd2, col='red', lwd=2)
...
kd1 <- density(l1$vel.flow[l1$Light=="Present"])
plot(kd1, xlim = c(-12,12), ylim = c(0, 6), col='blue', lwd=2, main = "Velocity (in relation to flow, not logged) Vs Light")

kd2 <- density(l1$vel.flow[l1$Light=="Absent"])
lines(kd2, col='red', lwd=2)
...
plot(kd1, xlim = c(-15,15), ylim = c(0, 2.5), col='blue', lwd=2, main = "Velocity (not logged, in relation to flow) Vs Chlorophyll, Flow = 0")
...
plot(kd1, xlim = c(-15,15), ylim = c(0, 2.5), col='blue', lwd=2, main = "Velocity (not logged, in relation to flow) Vs Chlorophyll, Flow = 0.6")
