...
plot(kd1, xlim = c(-15,22), ylim = c(0, 170), col='blue', lwd=2, main = "Velocity (in relation to flow, not logged) Vs Flow Rate, Lights On")
...
plot(kd1, xlim = c(-15,22), ylim = c(0, 170), col='blue', lwd=2, main = "Velocity (in relation to flow, not logged) Vs Chlorophyll, Lights On")
...
plot(kd1, xlim = c(-15,22), ylim = c(0, 6), col='blue', lwd=2, main = "Velocity (in relation to flow, not logged) Vs Guano, Lights On")
...
plot(kd1, xlim = c(-15,22), ylim = c(0, 180), col='blue', lwd=2, main = "Velocity (in relation to flow, not logged) Vs Light")
...
plot(kd1, xlim = c(-180,180), ylim = c(0, 0.03), col='blue', lwd=2, main = "Heading Vs Flow Rate, Lights On")
...
plot(kd1, xlim = c(-180,180), ylim = c(0, 0.03), col='blue', lwd=2, main = "Heading Vs Chlorophyll, Lights On")
...
plot(kd1,  xlim = c(-180,180), ylim = c(0, 0.03), col='blue', lwd=2, main = "Heading Vs Guano, Lights On")
...
plot(kd1, xlim = c(-180,180), ylim = c(0, 0.04), col='blue', lwd=2, main = "Heading Vs Light")
...
plot(kd1, xlim = c(-90,90), ylim = c(0, 0.1), col='blue', lwd=2, main = "Pitch Vs Flow Rate")
...
plot(kd1, xlim = c(-90,90), ylim = c(0, 0.1), col='blue', lwd=2, main = "Pitch Vs Chlorophyll")
...
plot(kd1, xlim = c(-90,90), ylim = c(0, 0.1), col='blue', lwd=2, main = "Pitch Vs Guano")
...
plot(kd1, xlim = c(-90,90), ylim = c(0, 0.1), col='blue', lwd=2, main = "Pitch Vs Light")
