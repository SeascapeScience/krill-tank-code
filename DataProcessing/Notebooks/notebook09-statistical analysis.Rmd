...
plot(kd1, xlim = c(-12,12), ylim = c(0, 6), col='blue', lwd=2, main = "Velocity (in relation to flow, not logged) Vs Flow Rate, Lights On")
...
kd1 <- density(l1$vel.flow[l1$Chlorophyll=="0"])
plot(kd1, xlim = c(-12,12), ylim = c(0, 6), col='blue', lwd=2, main = "Velocity (in relation to flow, not logged) Vs Chlorophyll, Lights On")

kd2 <- density(l1$vel.flow[l1$Chlorophyll=="4.3"])
lines(kd2, col='light blue', lwd=2)

kd3 <- density(l1$vel.flow[l1$Chlorophyll=="4.6"])
lines(kd3, col='yellow', lwd=2)

kd8 <- density(l1$vel.flow[l1$Chlorophyll=="5.5"])
lines(kd8, col='orange', lwd=2)

kd4 <- density(l1$vel.flow[l1$Chlorophyll=="6.1"])
lines(kd4, col='red', lwd=2)

kd5 <- density(l1$vel.flow[l1$Chlorophyll=="7.6"])
lines(kd5, col='dark red', lwd=2)

kd6 <- density(l1$vel.flow[l1$Chlorophyll=="13.5"])
lines(kd6, col='purple', lwd=2)

kd7 <- density(l1$vel.flow[l1$Chlorophyll=="19"])
lines(kd7, col='black', lwd=2)
...
plot(kd1, xlim = c(-12,12), ylim = c(0, 6), col='blue', lwd=2, main = "Velocity (in relation to flow) Vs Guano, Lights On")
...
plot(kd1, xlim = c(-12,12), ylim = c(0, 6), col='blue', lwd=2, main = "Velocity (in relation to flow) Vs Light")
