...
plot(data$Flow.rate, data$vel.flow, xlab = "Chlorophyll (mg L-1)", ylab = "Velocity in relation to flow (cm s-1)")
...
a <- ggplot(Medflow,aes(x = Chem, y = log10(v), fill= Chem))+
  ...
  labs(size = "", x = "Chemical Cue", y = "Ground Velocity (logged, cm s-1)", title = "Medium Flow (3 cm s-1)") +
