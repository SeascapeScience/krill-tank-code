...
a <- ggplot(agg, aes(x = turn.angle, y = frequency(turn.angle), color = Chlorophyll)) + coord_polar(theta = "x", start = 3.142, direction=1)
...
a + theme_classic()+
  ...
  scale_colour_manual(values=c("gray90", "gray80", "gray75","gray60","grey45", "grey30", "slategray"),name = "Chemical Cue",
                    labels=c("No Chlorophyll", "Low Chlorophyll", "Medium Chlorophyll", "High Chlorophyll", "Extreme Chlorophyll", "Filament"))+
  geom_point(aes(shape = Flow, size = 4)) +
