...
a <- ggplot(agg, aes(x = turn.angle, y = frequency(turn.angle), color = Light)) + coord_polar(theta = "x", start = 3.142, direction=1)
...
a + theme_classic()+
  ...
  scale_colour_manual(values=c("gray75", "grey30"),name = "Light",
                    labels=c("Absent", "Present"))+
  geom_point(aes(shape = Chlorophyll), size = 4) +
  facet_grid(facets = Flow.Direction*Flume ~ Flow, labeller = label_both)
