...
a <- ggplot(vert, aes(x = turn.angle, y = frequency(turn.angle), color = Guano)) + coord_polar(theta = "x", start = 3.142, direction=1)
...
a + theme_classic()+
  ...
  theme(axis.line = element_line(size = 0.5, linetype = "solid",
                                   colour = "black")) + 
  geom_segment(aes(y = 0, xend = turn.angle, yend = 1)) +
