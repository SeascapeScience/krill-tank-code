...
```{r}
rm(list=ls(all=TRUE))
load("~/Post-doc/Data/Vertical Data File (Nov 12 2024).RData")

data <- read.csv("~/Bigelow/Data/ALL Pathwise Means.csv", header = TRUE, sep = ",")
str(data)
head(data)
...
data$Chlorophyll <- as.factor(data$Chlorophyll)
data$Flow <- as.factor(data$Flow)
data$Light <- as.factor(data$Light)
data$Guano <- as.factor(data$Guano)
data$Flume <- as.factor(data$Flume)
data$Flow.Direction <- as.factor(data$Flow.Direction)
...
data <- TotalData
str(data)
levels(data$Flow) <- c("No Flow","Low Flow (0.6)","Low Flow (1.5)", "Medium Flow (3)", "High Flow (3.5)", "High Flow (5.9)","Extreme Flow (8.9)")
plot(data$Flow.rate, data$v, xlab = "Flow rate (cm s-1)", ylab = "Velocity (cm s-1)", ylim = c(0, 25))
levels(data$Chlorophyll)
levels(data$Chlorophyll) <- c("No Chlorophyll", "Low Chlorophyll", "Low Chlorophyll","Low Chlorophyll","Low Chlorophyll", "Extreme Chlorophyll", "High Chlorophyll", "High Chlorophyll","High Chlorophyll","High Chlorophyll","High Chlorophyll","High Chlorophyll","High Chlorophyll","High Chlorophyll","High Chlorophyll","High Chlorophyll","High Chlorophyll","High Chlorophyll","High Chlorophyll","High Chlorophyll","High Chlorophyll","High Chlorophyll","High Chlorophyll","High Chlorophyll","High Chlorophyll", "Low Chlorophyll", "Low Chlorophyll", "Low Chlorophyll", "Low Chlorophyll", "Low Chlorophyll", "Low Chlorophyll", "High Chlorophyll", "High Chlorophyll",  "Low Chlorophyll",  "Low Chlorophyll", "Low Chlorophyll","Low Chlorophyll",  "Low Chlorophyll", "Low Chlorophyll", "Low Chlorophyll", "Medium Chlorophyll", "Medium Chlorophyll", "Medium Chlorophyll","Medium Chlorophyll","Medium Chlorophyll","Medium Chlorophyll","Medium Chlorophyll","Medium Chlorophyll","Medium Chlorophyll","Medium Chlorophyll","Medium Chlorophyll","Medium Chlorophyll","Medium Chlorophyll","Medium Chlorophyll","Medium Chlorophyll","Medium Chlorophyll","Medium Chlorophyll","Medium Chlorophyll","Medium Chlorophyll","Medium Chlorophyll","Medium Chlorophyll","Medium Chlorophyll","Medium Chlorophyll", "Filament")
data$Chlorophyll <- ordered(data$Chlorophyll, levels = c("No Chlorophyll", "Low Chlorophyll", "Medium Chlorophyll", "High Chlorophyll", "Extreme Chlorophyll", "Filament"))
plot(data$Chlorophyll, data$v, xlab = "Chlorophyll (mg L-1)", ylab = "Velocity (cm s-1)")

### order flow rate levels
levels(data$Flow.rate)
#### order flow direction order
levels(data$Flow.Direction)
data$Flow.Direction <- ordered(data$Flow.Direction, levels = c("No Flow", "Horizontal", "Upwelling", "Downwelling"))
...
```{r}
a <- ggplot(data, aes(x = Flow, y = v, fill= Chlorophyll))+
  ...
  stat_summary(geom = "errorbar", fun.min = mean, fun = mean, fun.max = mean,
               width = .75, linetype = "dashed", position = position_dodge())+
  ...
  labs(size = "", x = "Flow Rate (cm s-1 (Horizontal), mm s-1 (Vertical))", y = "Ground Velocity (cm s-1)", title = "") +
  ...
  facet_grid(Flume*Flow.Direction ~ Light, labeller = label_both, scales = "free_x", space = "free")
a

b <- ggplot(data,aes(x = Flow, y = heading.pi, fill= Chlorophyll))+
  geom_boxplot(notch=F, notchwidth=0.3,outlier.shape=1,outlier.size=2, coef=1.5)+
  theme(legend.key.size = unit(2, "cm"))+
  theme(text = element_text(size = 16))+
  ##stat_summary(fun=mean, geom="line", lty=2, lwd=1, col = "black", aes(group=1)) +
  ...
  theme(axis.line = element_line(size = 0.5, linetype = "solid",
                                   colour = "black"))+
  theme(legend.key = element_rect(fill = "white"))+
  labs(size = "", x = "Flow Rate (cm s-1 (Horizontal), mm s-1 (Vertical))", y = "Horizontal Heading (degrees)", title = "") +
  scale_fill_manual(values=c("white", "gray90", "gray75","gray60","grey45", "grey30", "slategray"),name = "Chemical Cue",
                    labels=c("No Chlorophyll", "Low Chlorophyll", "Medium Chlorophyll", "High Chlorophyll", "Extreme Chlorophyll", "Filament"))+
  facet_grid(Flume*Flow.Direction ~ Light, labeller = label_both, scales = "free_x", space = "free")
b

c <- ggplot(data ,aes(x = Flow, y = v.heading/(2*pi)*360, fill= Guano))+
  geom_boxplot(notch=F, notchwidth=0.3,outlier.shape=1,outlier.size=2, coef=1.5)+
  theme(legend.key.size = unit(2, "cm"))+
  theme(text = element_text(size = 16))+
  ##stat_summary(fun=mean, geom="line", lty=2, lwd=1, col = "black", aes(group=1)) +
  ...
  theme(axis.line = element_line(size = 0.5, linetype = "solid",
                                   colour = "black"))+
  theme(legend.key = element_rect(fill = "white"))+
  labs(size = "", x = "Flow Rate (cm s-1 (Horizontal), mm s-1 (Vertical))" , y = "Vertical Heading (degrees)", title = "") +
  scale_fill_manual(values=c("white",  "slategray"),name = "Guano Cue",
...
Aggregating data and making POlar Plots with lines and Points
...
agg = aggregate(data,
                by = list(data$Flow.Direction, data$Flume, data$Guano, data$Light, data$Flow, data$Chlorophyll),
                FUN = mean)
agg <- agg[ -c(7:15)]
colnames(agg) <- c('Flow.Direction', 'Flume', 'Guano', 'Light', 'Flow', 'Chlorophyll', 'X', 'Y', 'Z', 'dx', 'dy', 'dz', 'd', 'vx', 'vy', 'vz', 'v', 'h.heading', 'v.heading', 'turn.anglexy', 'turn.angleyz', 'turn.angle', 'vel.turn.angle', 'vel', 'vel.flow', 'trim.X', 'xsmooth', 'ysmooth', 'zsmooth', 'smooth.dx', 'smooth.dy', 'smooth.dz', 'smooth.d', 'smooth.vx', 'smooth.vy', 'smooth.vz', 'smooth.v', 'smooth.h.heading', 'heading.pi', 'smooth.v.heading', 'smooth.pitch', 'turn.anglexysmooth', 'turn.angleyzsmooth', 'turn.angle.smooth')
str(agg)

vert <- subset(agg, Flume == "Vertical")
str(vert)
vert$smooth.pitch <- vert$v.heading/(2*pi)*360

#################### Polar plot for vertical MS #########################################

a <- ggplot(vert, aes(x = smooth.pitch, y = frequency(smooth.pitch), color = Guano)) + coord_polar(theta = "x", start = 3.142, direction=1)
a
a + theme_classic()+
  ...
  theme(axis.line = element_line(size = 0.5, linetype = "solid",
                                   colour = "black")) + 
  geom_segment(aes(y = 0, xend = smooth.pitch, yend = 1)) +
  labs(x = "Vertical Heading (degrees)", y = "Frequency of Heading", title = "") +
  scale_colour_manual(values=c("gray85", "grey35"),name = "Guano",
                    labels=c("Absent", "Present"))+
  geom_point(aes(shape = Chlorophyll), size = 4, alpha = 0.8, position = position_dodge(width = 1)) +
  facet_grid(facets = Light ~ Flow.Direction*Flow , labeller = label_both)
...
ggplot(data,aes(x=Flow.rate, y=h.heading.pi, fill=Guano))+
  geom_boxplot(notch=F, notchwidth=0.3,outlier.shape=1,outlier.size=2, coef=1.5)+
  theme(axis.text=element_text(color="black"))+
  theme(axis.text.x=element_text(angle=90,hjust=1,vjust=0.4))+
  theme(panel.grid.minor=element_blank())+
...
AGG_Dark %>% group_by(Flow.Rate, Chemical.Cue) %>% summarise_at(vars(turn.angle.smooth.degrees), lst(min, max, mean, sd))
...
range(AGG_Dark$turn.anglexysmooth)
AGG_Feed$turn.anglexysmooth <- AGG_Feed$turn.anglexysmooth/(2*pi)*360

circ.turn <- circular(data$turn.angle, type = c("angles"),
          units = c("degrees"),
...
## S3 method for class 'circular'
plot(circ.turn, pch = 16, cex = 1, stack = TRUE,
...
aov.circular(circ.turn, data$Flow) ## working but unsure

circ.mean <- mean(circ.turn, na.rm = TRUE)

plot.circular(circ.turn, stack = T, pch = 20, sep = 0.08, shrink = 1.6)  ### larger stack number = more zoomed out
arrows.circular(circ.mean) #add mean to plot
...
circ.mean <- mean(circ.turn, na.rm = TRUE) #assigns to the 'LNN.mean' object
...
plot.circular(circ.turn, stack = T, pch = 20, sep = 0.08, shrink = 1.6)
arrows.circular(circ.mean) #add mean to plot
###########################################################################
...
circDH <- circular(AGG_DH$turn.anglexysmooth, type = c("angles"),
          units = c("degrees"),
          template = c("geographics"))
...
rayleigh.test(circ.turn)  ## if significant shows non-uniformity of direction  (No flow vs extreme flow)
...
data1 <- list(dahi = circular(AGG_DH$turn.anglexysmooth, units="degrees", template="geographics"), dame = circular(AGG_DM$turn.anglexysmooth, units="degrees", template="geographics"))
...
write.csv(CC.TotalData, file = "~/Bigelow/Data/CC.TotalData.July.15.2024.csv", row.names = FALSE)

write.csv(data, file = "~/Bigelow/Data/data.July.15.2024.csv", row.names = FALSE)
