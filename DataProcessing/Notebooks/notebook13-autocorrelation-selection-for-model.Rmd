...
CC.TotalData$Light <- as.numeric(CC.TotalData$Light)
CC.TotalData$Guano <- as.numeric(CC.TotalData$Guano)
CC.TotalData$Flow.rate <- as.numeric(CC.TotalData$Flow.rate)
CC.TotalData$Flow.Direction <- as.numeric(CC.TotalData$Flow.Direction)
```
...
Save fit models
```{r}
save(conditions.rf.slope,conditions.rf.intercept,conditions.rf.sigma, file='notebook13-rf-24.07.2023data.RData')
```
