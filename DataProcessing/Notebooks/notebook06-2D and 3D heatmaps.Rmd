...
ggplot(gg.df, aes(x=X, y=Y, alpha=Z, fill=Flow.rate)) + geom_raster() + coord_fixed()
...
```{r}
save.image("~/Post-doc/Data/Total Merged Data File (Dec 15 2021).RData")
