...
ChlA5.5 <- CC.TotalData[CC.TotalData$Chlorophyll == "5.5",]  ##subsets CC.TotalData by Chlorophyll but only selects rows where Chlorophyll = 4.6
head(ChlA5.5)
tail(ChlA5.5)
...
image.plot(s, axes=TRUE, xlab = "X", ylab = "Y", legend.lab = "Z", legend.width = .4, legend.line = -1.5)
...
```{r}
save.image("~/Post-doc/Data/Total Merged Data File (July 24 2022).RData")
