...
for (i in 1:10){  
  ...
  c.e <- rf.skill(df = df, trees = 2000, prop = 0.8) ## try neural net vs random forest and other models, multiple parameter outputs 
  c.v <- rbind(c.e, c.v)  
  c.e.t <- rf.skill(df = df, trees = 2000, prop = 0.8) ## training data cor.test coef
