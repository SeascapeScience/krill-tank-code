...
for (i in 1:10){  
  ...
  c.e <- rf.skill(df = df, trees = 2000, "ave.v") ## try neural net vs random forest and other models
  c.v <- rbind(c.e, c.v)  
  c.e.t <- rf.skill.test(df = df, trees = 2000, "ave.v", prop = 0.5, strata = NULL, do.plot = TRUE) ## training data
