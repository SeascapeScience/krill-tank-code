...
ggp <- ggplot(node, aes(Swimming.Parameter, Swimming.Factor)) +                           # Create heatmap with ggplot2
  ...
  facet_grid(~Environmental.Input, scales = "free_x", space = "free")# Print heatmap
ggp + labs(x = "Swimming Parameter", y = "Swimming Factor", title = "Node Purity Heatmap", fill = "Node Purity Value")
...
## save each parameter model individually or as single file (single RData file - individual objects therein) - include readme.doc for what each object in environemnt in
