...
load("C:\\Users\\Nicole Hellessey\\Documents\\Post-doc\\Data\\Total Merged Data File (July 24 2023).Rdata")
...
levels(CC.TotalData$Chlorophyll) <- c("No Chlorophyll", "No Chlorophyll",  "High Chlorophyll",  "High Chlorophyll",  "High Chlorophyll", "Low Chlorophyll", "Low Chlorophyll",  "Low Chlorophyll", "Low Chlorophyll", "Low Chlorophyll", "Low Chlorophyll", "Low Chlorophyll", "Medium Chlorophyll", "Medium Chlorophyll", "Medium Chlorophyll",  "Medium Chlorophyll", "Medium Chlorophyll",  "Medium Chlorophyll", "Medium Chlorophyll", "Filament")
str(CC.TotalData)
...
AGG_TD <- aggregate(CC.TotalData, by = list(CC.TotalData$D_V_T, CC.TotalData$Guano, CC.TotalData$Light), FUN = mean)
head(AGG_TD)
AGG_TD <- AGG_TD[ -c(4:5, 9:12, 15:16) ]
colnames(AGG_TD) <- c("Ind", "Guano", "Light", "X", "Y", "Z", "Flow.Rate", "Chlorophyll", "dx", "dy", "dz", "d", "vx", "vy", "vz", "v", "heading", "pitch", "turn.anglexy", "turn.angleyz", "turn.angle")##, "vel.flow", "vel.turn.angle", "trim.X", "xsmooth", "ysmooth", "zsmooth", "log.vel.flow", "heading.pi", "pitch.perfect")
head(AGG_TD)
tail(AGG_TD)
...
freq <- table(CC.TotalData$Light, CC.TotalData$Guano)
print(freq)
