...
```{r}
x1 <- CC.TotalData$trim.X[1:(nrow(CC.TotalData)-1)]
x2 <- CC.TotalData$trim.X[2:nrow(CC.TotalData)]
...
```{r}
CC.TotalData$turn.anglexy <- atan2(CC.TotalData$trim.X, CC.TotalData$Y)
