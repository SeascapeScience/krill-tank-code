...
range(Feeding$turn.anglexysmooth)
...
Feeding %>%
  ...
  scale_fill_manual(values=c("lightgray", "gray", "gray35"),name = "Chemical Cue",
...
Feeding %>%
  ...
  stat_bin_(data = Feeding,  position = "stack", binwidth = 15, colour = "black", size = .25)+
  coord_polar(theta = "x", start = 3.142, direction=1)+
