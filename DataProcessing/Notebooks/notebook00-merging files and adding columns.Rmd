...
df$D_V_T <- paste(ldf$Date, ldf$View, ldf$Track, sep='_')
df$D_V_T <- as.factor(ldf$D_V_T)
## Date_view factor created
df$D_V <- paste(ldf$Date, ldf$View, sep='_') 
df$D_V <- as.factor(ldf$D_V)
...
```{r}
save.image("~/Post-doc/Data/Total Merged Data File (August 17 2022).RData")
